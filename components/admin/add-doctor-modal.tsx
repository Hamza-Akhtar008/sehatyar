"use client"
import { registerDoctor, registerDoctor0, registerDoctorIndividual } from "@/lib/Api/Auth/api";
...
export default function AddDoctorModal({ onClose,fetchDoctors }: { onClose: () => void,fetchDoctors:()=>void }) {
...
for (let entry of formDataToSend.entries()) {
  ...
  try {
    ...
    await registerDoctorIndividual(formDataToSend);
